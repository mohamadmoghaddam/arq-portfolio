...
<head>
  ...
  <!-- Favicons -->
  <link href="{{ URL::asset('assets/index/img/favicon.png') }}" rel="icon">
  <link href="{{ URL::asset('assets/index/img/apple-touch-icon.png') }}" rel="apple-touch-icon">
  ...
  <link href="{{ URL::asset('assets/index/css/style.css') }}" rel="stylesheet">
...
@yield('index')
      ...
      <script src="{{ URL::asset('assets/index/vendor/waypoints/noframework.waypoints.js') }}"></script>
